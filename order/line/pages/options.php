...
?>
    <span class="d-flex flex-row w-100 bg-light rounded-2 p-4 fw-bold"><?php echo $catinf['name'] ?></span>
    ...
    <div class="row g-4">
        ...
        <script>
            $(document).ready(function() {
                ...
                if (limit != '-1') {
                    $(`input[type="checkbox"][name^="options[${limit}]"]`).on('change', function(evt) {
